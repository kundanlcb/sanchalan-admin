...
import { AcademicStructureControllerApi } from './api/academic-structure-controller-api';
...
export const academicStructureApi = new AcademicStructureControllerApi(config, undefined, apiClient);
